...
#to cut the lenght of the variables we need to minimize the width of characters by line which makes them more readable chunck of code needs to be copied from solutions sheet
...
oldest_hosp_plot <- tbi_age %>% 
  ...
  ggplot(aes(x= injury_mechanism, y= number_est,colour = as_factor(injury_mechanism) )) +
  geom_col()
